                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-check" data-children-count="1">
                                            <input type="checkbox" class="form-check-input" value="1" name="status" id="status" checked>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="seo_subtitle" name="seo_subtitle">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="seo_keywords" name="seo_keywords">
                                    </div>
                                </div>
