                            ...
                            <table class="datatable table table-stripped mb-0">
                                ...
                                <tbody>
                                    @foreach ($news as $data)
                                        <tr>
                                            <td>{{$loop->index + 1}}</td>
                                            <td><img src="{{asset('public/uploads/news/'.$data->image)}}" alt="" width="150px"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:" class="btn btn-danger btn-sm deleteRecord" rel="{{$data->id}}" rel1="delete-news"><i class="la la-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
