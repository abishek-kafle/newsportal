...
@section('title')
    All Categories - {{config('app.name','News')}}
@endsection
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <p><a href="#" class="text-danger">InActive</a></p>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{route('category.edit',$category->id)}}" class="btn btn-info"><i class="la la-edit"></i></a>
                                            <a href="javascript:" class="btn btn-danger deleteRecord" rel="{{$category->id}}" rel1="delete-category"><i class="la la-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
