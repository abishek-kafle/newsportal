                        ...
                        <div class="blog-single">
                            <div class="inner-box">
                                <div class="upper-box">
                                    ...
                                    <ul class="post-meta">
                                        ...
                                        <li><span class="icon qb-eye"></span>{{$news_detail->view_count}}</li>
                                    </ul>
                            ...
                            <div class="author-box">
                                <div class="author-comment">
                                    <div class="inner-box">
                                        <div class="image"><img src="{{asset('public/uploads/'.$news_detail->admin->image)}}" alt="" /></div>
                                        <h4>{{$news_detail->admin->name}}</h4>
                            ...
                            <div id="disqus_thread"></div>
                                <script>
                                    ...
                                    */
                                    ...
                                    s.src = 'https://news-portal-4.disqus.com/embed.js';
