    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
                                    ...
                                    <div class="content">
                                        <div class="row clearfix">
                                        	<div class="column col-md-6 col-sm-6 col-xs-12">
                                            	<div class="single-item-carousel owl-carousel owl-theme">
                                                    @php
                                                        $news_category = \App\Models\News::where('category_id', $category->id)->latest()->take(5)->get();
                                                    @endphp
                                                    <!--News Block Two-->
                                                ...
                                                @foreach($categories_news_views as $cat_views_news)
                                                    @if($category->id == $cat_views_news->category_id)
                                                        ...
                                                        <article class="widget-post">
                                                            <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/uploads/news/'.$cat_views_news->image)}}" alt=""></a><div class="overlay"></div></figure>
                                                            <div class="text"><a href="blog-single.html">{{$cat_views_news->news_title}}</a></div>
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab active-tab" id="prod-popular">
                                            <div class="content">
                                                ...
                                                <article class="widget-post">
                                                    <figure class="post-thumb"><a href="{{route('newsSingle',$post->slug)}}"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/uploads/news/'.$post->image)}}" alt=""></a><div class="overlay"></div></figure>
                                        ...
                                        <div class="tab" id="prod-recent">
                    						<div class="content">
                                                ...
                                                <article class="widget-post">
                                                    <figure class="post-thumb"><a href="{{route('newsSingle',$recent->slug)}}"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/uploads/news/'.$recent->image)}}" alt=""></a><div class="overlay"></div></figure>
                                                    <div class="text"><a href="{{route('newsSingle',$recent->slug)}}">{{$recent->news_title}}</a></div>
                                                    <div class="post-info">{{$recent->created_at->diffForHumans()}}</div>
                                                </article>
                                                @endforeach
            ...
            <div class="fullwidth-add text-center">
            	<div class="image">
                	<a href="#"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/add-1.jpg')}}" alt="" /></a>
                </div>
            </div>
    	...
    	<div class="auto-container">
        	<div class="three-item-carousel owl-carousel owl-theme">
            	...
            	<div class="news-block-three">
                	<div class="inner-box">
                    	<div class="image">
                        	<img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/news-7.jpg')}}" alt="" />
                            <div class="overlay-box">
            	...
            	<div class="news-block-three">
                	<div class="inner-box">
                    	<div class="image">
                        	<img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/news-8.jpg')}}" alt="" />
                            <div class="overlay-box">
                            	<a href="blog-single-2.html" class="play-btn"><span class="icon qb-play-arrow"></span></a>
                                <div class="content">
            	...
            	<div class="news-block-three">
                	<div class="inner-box">
                    	<div class="image">
                        	<img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/news-9.jpg')}}" alt="" />
                            <div class="overlay-box">
                            	<a href="blog-single-2.html" class="play-btn"><span class="icon qb-play-arrow"></span></a>
                                <div class="content">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="content-box col-md-6 col-sm-6 col-xs-12">
                                        <div class="content-inner">
                                            ...
                                            <div class="text">{{Str::limit(strip_tags($data->news_content),200,'.........')}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                	...
                	<aside class="sidebar default-sidebar">
                        ...
                        <div class="sidebar-widget recent-news-widget home-one">
                            ...
                            <div class="news-block-five">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/news-14.jpg')}}" alt="" /></a>
                            ...
                            <article class="widget-post-two">
                                <div class="inner">
                                    <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/post-thumb-5.jpg')}}" alt=""></a></figure>
                            ...
                            <article class="widget-post-two">
                                <div class="inner">
                                    <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/post-thumb-2.jpg')}}" alt=""></a></figure>
                            ...
                            <article class="widget-post-two">
                                <div class="inner">
                                    <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{asset('public/assets/images/resource/post-thumb-3.jpg')}}" alt=""></a></figure>
